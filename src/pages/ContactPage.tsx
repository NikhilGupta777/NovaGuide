...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // In production, this would send to an edge function / email service
    setSubmitted(true);
  };
  ...
  return (
    <Layout>
      <SEOHead
        title="Contact Us"
        description="Have a question, suggestion, or need help? Reach out to the DigitalHelp team. We'd love to hear from you."
      />
            ...
            <form onSubmit={handleSubmit} className="space-y-5 bg-card rounded-xl border border-border p-6 md:p-8">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-input bg-background text-foreground text-sm outline-none focus:ring-2 focus:ring-ring resize-none"
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="p-5 rounded-xl bg-card border border-border">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Can't find what you need? Let us know and our AI will research and create a guide for it.
              </p>
            </div>
            <div className="p-5 rounded-xl bg-card border border-border">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Found incorrect information in an article? Let us know so we can fix it right away.
              </p>
            </div>
          </div>
        </motion.div>
